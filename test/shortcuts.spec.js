...
describe("Shortcuts component", () => {
    ...
    it("should render component", () => {
        ...
        const wrapper = enzyme.mount(shortcutComponent, {
            context: baseContext,
        })
    ...
    it("should have children", () => {
        const props = _.assign({}, baseProps, {
            children: ReactDOMFactories.div(),
        })
        const shortcutComponent = React.createElement(Shortcuts, props)
        const wrapper = enzyme.mount(shortcutComponent, {
            context: baseContext,
    ...
    it("should have name prop", () => {
        const props = _.assign({}, baseProps, { name: "TESTING" })
        const shortcutComponent = React.createElement(Shortcuts, props)
        const wrapper = enzyme.mount(shortcutComponent, {
            context: baseContext,
        })
    ...
    it("should not fire when the component has been unmounted", () => {
        ...
        const shortcutComponent = React.createElement(Shortcuts, {
            ...baseProps,
            handler,
        })
        const wrapper = enzyme.mount(shortcutComponent, {
    ...
    it("should fire the handler from a child input", () => {
        const props = _.assign({}, baseProps, {
            children: ReactDOMFactories.input({
                type: "text",
                className: "input",
            }),
        })
    ...
    it("should fire the handler when using targetNodeSelector", () => {
        ...
        const enter = 13
        simulant.fire(document.body, "keydown", {
            keyCode: enter,
            key: "Enter",
        })
        ...
        it("should not fire parent handler when child handler is fired", () => {
            const props = _.assign({}, baseProps, {
                children: React.createElement(
                    Shortcuts,
                    _.assign({}, baseProps, { className: "test" }),
                ),
            })
            const shortcutComponent = React.createElement(Shortcuts, props)
            const wrapper = enzyme.mount(shortcutComponent, {
